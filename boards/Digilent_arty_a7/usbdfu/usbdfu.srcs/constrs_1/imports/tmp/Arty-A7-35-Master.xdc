...
set_property -dict { PACKAGE_PIN C11   IOSTANDARD LVCMOS33 } [get_ports { boot }]; #IO_L13P_T2_MRCC_16 Sch=sw[1]
...
## Pmod Header JA
set_property -dict { PACKAGE_PIN G13   IOSTANDARD LVCMOS33 } [get_ports { pin_usb_p }]; #IO_0_15 Sch=ja[1]
set_property -dict { PACKAGE_PIN B11   IOSTANDARD LVCMOS33 } [get_ports { pin_usb_n }]; #IO_L4P_T0_15 Sch=ja[2]
